...
function center1(data) {
    $('#confirm').text(data.diseaseh5Shelf.chinaTotal.confirm);
    $('#heal').text(data.diseaseh5Shelf.chinaTotal.heal);
    $('#dead').text(data.diseaseh5Shelf.chinaTotal.dead);
    $('#nowConfirm').text(data.diseaseh5Shelf.chinaTotal.nowConfirm);
    $('#noInfect').text(data.diseaseh5Shelf.chinaTotal.noInfect);
    $('#import').text(data.diseaseh5Shelf.chinaTotal.importedCase);
}


function center2(data) {
    var myChart = echarts.init($('#center2')[0], 'light');
    var option = {
        title: {
            text: '\n\n中国地区累计确诊分布',
            left: 'center',
...
function right1(data) {
    var myChart = echarts.init($('#right1')[0], 'light');
    var option = {
        title: {
            text: "全国确诊省市TOP10",
            textStyle: {
...
function right2(data) {
    var myChart = echarts.init($('#right2')[0], 'light');
    ...
    var provinces = data.diseaseh5Shelf.areaTree[0].children; //境外输入的判断
    var topData = [];
    for (var province of provinces) {
...
function left1(data) {
    var myChart = echarts.init($('#left1')[0], 'light');
    var option = {
        title: {
            text: "全国累计趋势",
            textStyle: {
...
function left2(data) {
    var myChart = echarts.init($('#left2')[0], 'light');
    var option = {
        title: {
            text: "全国新增趋势",
            textStyle: {
